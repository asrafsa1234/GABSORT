    ...
    return (
        <div className="animate-fade-in space-y-4">
            ...
            <div className="text-center">
                ...
                <div className={`mt-1 text-xl font-bold flex items-center justify-center ${recyclable === 'Yes' ? 'text-green-600' : 'text-red-600'}`}>
                    {recyclable === 'Yes' ? (
            ...
            <div>
                <h3 className="font-semibold text-sm text-gray-600" id="recyclability-score-label">Recyclability Score</h3>
                <div 
                    className="w-full bg-gray-200 rounded-full h-2.5 my-1"
                    role="progressbar"
                ...
                <p className="text-right font-bold text-sm text-gray-500">{recyclabilityScore}/100</p>
            </div>
            ...
            <div className="space-y-3 pt-2">
                ...
                <div className="p-3 bg-green-50 rounded-lg">
                     <h3 className="font-semibold text-green-800 text-sm">Eco Tip</h3>
                     <p className="text-green-700 text-sm italic">"{ecoFriendlyTip}"</p>
                </div>
            </div>
